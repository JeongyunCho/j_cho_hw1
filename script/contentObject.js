var dynamicContent = {
		spring: {
			...
			imageDescription : [
				...
				'This is some flowers on sunny day',
				'This is some flowers on cloudy day',
				'This is some flowers windy day',
				'This is some purple flowers'
			]
		},
		...
		summer : {
			...
			imageDescription : [
				'Ocean View with colorful Chairs',
				'Puppy sleeping in hot summer day',
				'Writing summer on the sand',
				'Bright Ocean',
				'Sunset Ocean View with birds',
				'Sunset Ocean View Clouds'
			]
		},
		...
		winter : {
			...
			imageDescription : [
				'Night View of Forest in Winter',
				'Snowman',
				'Snowy Forest',
				'White Dogs White Field',
				'End of the Winter',
				'Entrace of Winter Forest'
			]
		}
	};